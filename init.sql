...
('Как начать обучение на платформе?', 'Для начала обучения зарегистрируйтесь на сайте, выберите подходящий курс и следуйте инструкциям в личном кабинете.'),
('Есть ли бесплатные материалы?', 'Да, на платформе доступны бесплатные материалы, включая открытый канал с обучающими постами и новостями.'),
('Как связаться с поддержкой?', 'Вы можете связаться с поддержкой через форму обратной связи на сайте или написав в чат комьюнити.'),
('Что такое D-Closed?', 'D-Closed — это закрытое сообщество для практикующих трейдеров, где доступны прямые трансляции сделок, софт и командная работа.'),
('Как часто обновляются материалы?', 'Материалы обновляются регулярно в зависимости от рыночных изменений и запросов участников.'),
('Можно ли вернуть деньги за подписку?', 'Да, если вы не использовали материалы, вы можете запросить возврат в течение 14 дней после покупки.');
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что такое криптовалюта?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Как работает децентрализация в криптовалютах?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой криптовалютой считается "цифровое золото"?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что из перечисленного относится к стейблкойнам?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что из этого может усилить корреляцию между криптовалютами и фондовыми рынками?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что лучше всего описывает мемкоины?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему усилилась корреляция между криптовалютами и фондовыми индексами?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой индекс включает в себя крупнейшие технологические компании и влияет на крипторынок?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какое из следующих утверждений — преимущество криптовалют?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('В чем заключается ценность ограниченной эмиссии криптовалют, таких как Bitcoin?', 1, (SELECT id FROM quizzes WHERE title = 'Что ты знаешь о криптовалютах?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой из следующих факторов прямо влияет на безопасность хранения средств на бирже?', 1, (SELECT id FROM quizzes WHERE title = 'Как выбрать криптобиржу?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему важно учитывать комиссии при выборе биржи?', 1, (SELECT id FROM quizzes WHERE title = 'Как выбрать криптобиржу?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что особенно важно в интерфейсе биржи для новичков?', 1, (SELECT id FROM quizzes WHERE title = 'Как выбрать криптобиржу?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Как репутация биржи может повлиять на ваше решение?', 1, (SELECT id FROM quizzes WHERE title = 'Как выбрать криптобиржу?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Зачем обращать внимание на регулирование биржи?', 1, (SELECT id FROM quizzes WHERE title = 'Как выбрать криптобиржу?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Для чего в первую очередь используется платформа TradingView?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько хорошо ты знаешь TradingView?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Как называется инструмент на TradingView, с помощью которого можно рисовать уровни поддержки и сопротивления?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько хорошо ты знаешь TradingView?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что позволяет сделать функция «Список наблюдения» (Watchlist)?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько хорошо ты знаешь TradingView?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Для чего используется функция «Алерт» (оповещение) на TradingView?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько хорошо ты знаешь TradingView?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Как сохранить собственный шаблон графика с нанесёнными индикаторами и разметкой?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько хорошо ты знаешь TradingView?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что такое скальпинг в трейдинге?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Как называется торговля, при которой сделки открываются и закрываются в течение одного дня?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Кто больше всего склонен к свинг-трейдингу?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какая торговая стратегия требует наименьшего времени и эмоционального вовлечения?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой тип личности лучше всего подходит для скальпинга?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что может быть проблемой для интрадей-трейдера при длительном отсутствии сигналов?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему позиционные трейдеры часто менее подвержены эмоциональному напряжению?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что должно быть первым шагом при выборе торговой стратегии?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему важно тестировать стратегию на демо-счёте?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему важно учитывать свой тип личности при выборе стратегии?', 1, (SELECT id FROM quizzes WHERE title = 'Какой стиль трейдинга тебе подходит?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что показывает показатель WinRate?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Если трейдер совершил 100 сделок, и 60 из них прибыльные, какой у него WinRate?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой уровень WinRate считается сбалансированным и подходящим для большинства стратегий?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что такое RR в трейдинге?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Если трейдер рискует $100, чтобы заработать $300, какой у него RR?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('При каком RR можно быть прибыльным даже с WinRate 30%?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что произойдет, если у трейдера высокий WinRate, но низкий RR (например, 1:1)?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой подход позволяет трейдеру зарабатывать даже при низком проценте прибыльных сделок?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему не стоит оценивать стратегию только по WinRate?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что из ниже перечисленного наиболее важно для стабильной прибыльности?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты WinRate и RR?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что должен осознать каждый, кто приходит на рынок в первую очередь?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты суть риск-менеджмента?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('К чему чаще всего приводит торговля без стоп-лосса?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты суть риск-менеджмента?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что происходит, если трейдер теряет половину депозита?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты суть риск-менеджмента?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что важнее для сохранения капитала на рынке?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты суть риск-менеджмента?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что может позволить трейдеру зарабатывать, даже если его стратегия неидеальна?', 1, (SELECT id FROM quizzes WHERE title = 'Понимаешь ли ты суть риск-менеджмента?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что такое биржевой стакан (Order Book)?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что происходит, когда маркет-ордер на покупку исполняется?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что делает лимитный ордер?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что такое проскальзывание?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Как влияет ликвидация лонгов на рынок?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что означает "агрессивный спрос" на рынке?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что делает iceberg-ордер особенным?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что такое spoofing?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Зачем маркет-мейкеры размещают встречные ордера в стакане?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему трейдерам важно следить за ликвидациями и глубиной стакана?', 1, (SELECT id FROM quizzes WHERE title = 'Насколько ты понимаешь рыночную механику?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему трейдинг считается не просто работой, а особым путем?', 1, (SELECT id FROM quizzes WHERE title = 'Что делает трейдинг свободой?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что символизирует каждая сделка на рынке?', 1, (SELECT id FROM quizzes WHERE title = 'Что делает трейдинг свободой?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Как трейдинг помогает в развитии личности?', 1, (SELECT id FROM quizzes WHERE title = 'Что делает трейдинг свободой?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что даёт трейдеру ощущение независимости?', 1, (SELECT id FROM quizzes WHERE title = 'Что делает трейдинг свободой?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что объединяет всех успешных трейдеров?', 1, (SELECT id FROM quizzes WHERE title = 'Что делает трейдинг свободой?')) RETURNING id;
...
INSERT INTO quizzes (title, description, lesson_id) VALUES ('Умеешь ли ты правильно заходить в сделки?', 'Тест для проверки знаний по теме', 9) RETURNING id;
INSERT INTO questions (text, type, quiz_id) VALUES ('Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?', 1, (SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?')) RETURNING id;
INSERT INTO answers (text, correct, question_id) VALUES ('Заходить на всю котлету', FALSE, (SELECT id FROM questions WHERE text = 'Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Игнорировать стоп-лосс, ведь вход лучше', FALSE, (SELECT id FROM questions WHERE text = 'Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Уменьшить плечо и не завышать объём — не жадничать', TRUE, (SELECT id FROM questions WHERE text = 'Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Увеличить объём позиции для максимальной прибыли', FALSE, (SELECT id FROM questions WHERE text = 'Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?'));
INSERT INTO questions (text, type, quiz_id) VALUES ('Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?', 1, (SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?')) RETURNING id;
INSERT INTO answers (text, correct, question_id) VALUES ('Удвоить позицию в случае разворота', FALSE, (SELECT id FROM questions WHERE text = 'Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Отменить сделку и ждать новую рекомендацию', FALSE, (SELECT id FROM questions WHERE text = 'Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Заходить по текущей цене на весь депозит', FALSE, (SELECT id FROM questions WHERE text = 'Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Поставить лимитный ордер и подождать или разделить вход на две части', TRUE, (SELECT id FROM questions WHERE text = 'Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?'));
INSERT INTO questions (text, type, quiz_id) VALUES ('Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?', 1, (SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?')) RETURNING id;
INSERT INTO answers (text, correct, question_id) VALUES ('Чтобы избежать проскальзывания', FALSE, (SELECT id FROM questions WHERE text = 'Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Чтобы сбалансировать риск при частичном входе', TRUE, (SELECT id FROM questions WHERE text = 'Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Чтобы выглядеть профессионально', FALSE, (SELECT id FROM questions WHERE text = 'Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Чтобы ускорить исполнение сделки', FALSE, (SELECT id FROM questions WHERE text = 'Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?'));
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?', 1, (SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?')) RETURNING id;
INSERT INTO answers (text, correct, question_id) VALUES ('Пропускать сделки, если не получается войти по копейке', FALSE, (SELECT id FROM questions WHERE text = 'Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Вход по лимитному ордеру на точке входа и ожидание', TRUE, (SELECT id FROM questions WHERE text = 'Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Моментальный вход по маркету без расчётов', FALSE, (SELECT id FROM questions WHERE text = 'Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Догонять цену и заходить по любой', FALSE, (SELECT id FROM questions WHERE text = 'Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?'));
INSERT INTO questions (text, type, quiz_id) VALUES ('Почему не стоит жадничать, даже если цена входа лучше рекомендованной?', 1, (SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?')) RETURNING id;
INSERT INTO answers (text, correct, question_id) VALUES ('Потому что брокер может наказать', FALSE, (SELECT id FROM questions WHERE text = 'Почему не стоит жадничать, даже если цена входа лучше рекомендованной?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Потому что это может нарушить соотношение риска и прибыли', TRUE, (SELECT id FROM questions WHERE text = 'Почему не стоит жадничать, даже если цена входа лучше рекомендованной?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Потому что лимитные ордера запрещены в этом случае', FALSE, (SELECT id FROM questions WHERE text = 'Почему не стоит жадничать, даже если цена входа лучше рекомендованной?'));
INSERT INTO answers (text, correct, question_id) VALUES ('Потому что стратегия меняется на каждой свече', FALSE, (SELECT id FROM questions WHERE text = 'Почему не стоит жадничать, даже если цена входа лучше рекомендованной?'));
INSERT INTO quizzes (title, description, lesson_id) VALUES ('Знаешь ли ты, чем уникален D-Product?', 'Тест для проверки знаний по теме', 10) RETURNING id;
INSERT INTO questions (text, type, quiz_id) VALUES ('Что входит в состав D-Space и делает его особенно полезным для новичков и тех, кто хочет глубоко разобраться в трейдинге?', 1, (SELECT id FROM quizzes WHERE title = 'Знаешь ли ты, чем уникален D-Product?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Что делает D-Closed особенно сильным для практикующих трейдеров?', 1, (SELECT id FROM quizzes WHERE title = 'Знаешь ли ты, чем уникален D-Product?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Какой элемент присутствует и в D-Space, и в D-Closed, создавая сильное комьюнити?', 1, (SELECT id FROM quizzes WHERE title = 'Знаешь ли ты, чем уникален D-Product?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('Чем полезен открытый канал department для широкой аудитории?', 1, (SELECT id FROM quizzes WHERE title = 'Знаешь ли ты, чем уникален D-Product?')) RETURNING id;
...
INSERT INTO questions (text, type, quiz_id) VALUES ('В чём главное отличие всей экосистемы D-Product от большинства конкурентов?', 1, (SELECT id FROM quizzes WHERE title = 'Знаешь ли ты, чем уникален D-Product?')) RETURNING id;
