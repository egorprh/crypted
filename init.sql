...
VALUES 
            ('Урок 1: Что такое криптовалюта?', 'Основы криптовалют и их роль в современном мире.', 'https://kinescope.io/embed/ommU9afW4HccMLEvKsFfbE', 1, 'lesson1.jpg'),
            ('Урок 2: Как выбрать криптобиржу?', 'Рекомендации по выбору надежной биржи.', 'https://rutube.ru/play/embed/918aa9a7b659832a9a504f7046099444/', 1, 'lesson2.jpg'),
            ('Урок 3: TradingView для анализа рынка', 'Как использовать платформу TradingView.', 'https://vkvideo.ru/video_ext.php?oid=-223280655&id=456240038&hd=2', 1, 'lesson3.jpg'),
            ('Урок 4: Стиль трейдинга', 'Определение подходящего стиля трейдинга.', 'https://www.youtube.com/embed/DLGjMJyOaXQ?si=P-i8Q1IgsmcCRwoo', 1, 'lesson4.jpg'),
...
('Материал к уроку 3_2', '/content/app_data.json', '', 3),
...
('curator_btn_link', 'https://t.me/egorprh'),
('curator_btn_avatar', '/images/user.png'),
('bot_link', 'https://t.me/CryptEduBot');

-- 4. Добавляем вопросы и ответы для опросов
-- Вопрос 1: Укажите, пожалуйста, ваш номер телефона.
INSERT INTO questions (text, type) 
VALUES ('Укажите, пожалуйста, ваш номер телефона.', 'phone') RETURNING id;

-- Вопрос 2: Какой у вас уровень опыта в криптотрейдинге?
INSERT INTO questions (text, type) 
VALUES ('Какой у вас уровень опыта в криптотрейдинге?', 'quiz') RETURNING id;
INSERT INTO answers (text, correct, question_id) 
VALUES ('Начинающий (менее 1 года)', FALSE, (SELECT id FROM questions WHERE text = 'Какой у вас уровень опыта в криптотрейдинге?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Средний (1–3 года)', FALSE, (SELECT id FROM questions WHERE text = 'Какой у вас уровень опыта в криптотрейдинге?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Опытный (более 3 лет)', FALSE, (SELECT id FROM questions WHERE text = 'Какой у вас уровень опыта в криптотрейдинге?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Не занимаюсь трейдингом', FALSE, (SELECT id FROM questions WHERE text = 'Какой у вас уровень опыта в криптотрейдинге?'));

-- Вопрос 3: Какой стиль торговли вам ближе?
INSERT INTO questions (text, type) 
VALUES ('Какой стиль торговли вам ближе?', 'quiz') RETURNING id;
INSERT INTO answers (text, correct, question_id) 
VALUES ('Дневной трейдинг (day trading)', FALSE, (SELECT id FROM questions WHERE text = 'Какой стиль торговли вам ближе?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Скальпинг', FALSE, (SELECT id FROM questions WHERE text = 'Какой стиль торговли вам ближе?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Свинг-трейдинг (swing trading)', FALSE, (SELECT id FROM questions WHERE text = 'Какой стиль торговли вам ближе?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Долгосрочные инвестиции', FALSE, (SELECT id FROM questions WHERE text = 'Какой стиль торговли вам ближе?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Не торгую сам(а), использую алгоритмы', FALSE, (SELECT id FROM questions WHERE text = 'Какой стиль торговли вам ближе?'));

-- Вопрос 4: Какие источники данных вы предпочитаете использовать для анализа рынка?
INSERT INTO questions (text, type) 
VALUES ('Какие источники данных вы предпочитаете использовать для анализа рынка?', 'quiz') RETURNING id;
INSERT INTO answers (text, correct, question_id) 
VALUES ('Графики с бирж (Binance, Bybit и т. д.)', FALSE, (SELECT id FROM questions WHERE text = 'Какие источники данных вы предпочитаете использовать для анализа рынка?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('TradingView', FALSE, (SELECT id FROM questions WHERE text = 'Какие источники данных вы предпочитаете использовать для анализа рынка?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Telegram/Discord каналы', FALSE, (SELECT id FROM questions WHERE text = 'Какие источники данных вы предпочитаете использовать для анализа рынка?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Собственные алгоритмы/скрипты', FALSE, (SELECT id FROM questions WHERE text = 'Какие источники данных вы предпочитаете использовать для анализа рынка?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Новости и макроэкономические данные', FALSE, (SELECT id FROM questions WHERE text = 'Какие источники данных вы предпочитаете использовать для анализа рынка?'));

-- Вопрос 5: Какие криптовалютные пары вы торгуете чаще всего?
INSERT INTO questions (text, type) 
VALUES ('Какие криптовалютные пары вы торгуете чаще всего?', 'quiz') RETURNING id;
INSERT INTO answers (text, correct, question_id) 
VALUES ('BTC/USDT', FALSE, (SELECT id FROM questions WHERE text = 'Какие криптовалютные пары вы торгуете чаще всего?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('ETH/USDT', FALSE, (SELECT id FROM questions WHERE text = 'Какие криптовалютные пары вы торгуете чаще всего?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Альткоины (SOL, AVAX, MATIC и т. д.)', FALSE, (SELECT id FROM questions WHERE text = 'Какие криптовалютные пары вы торгуете чаще всего?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Торгую только фьючерсы', FALSE, (SELECT id FROM questions WHERE text = 'Какие криптовалютные пары вы торгуете чаще всего?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Не торгую самостоятельно', FALSE, (SELECT id FROM questions WHERE text = 'Какие криптовалютные пары вы торгуете чаще всего?'));

-- Вопрос 6: Хотели бы вы тестировать новые алгоритмы компании Dept на демо-счете?
INSERT INTO questions (text, type) 
VALUES ('Хотели бы вы тестировать новые алгоритмы компании Dept на демо-счете?', 'quiz') RETURNING id;
INSERT INTO answers (text, correct, question_id) 
VALUES ('Да, было бы интересно', FALSE, (SELECT id FROM questions WHERE text = 'Хотели бы вы тестировать новые алгоритмы компании Dept на демо-счете?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Возможно, если они покажут хорошие результаты', FALSE, (SELECT id FROM questions WHERE text = 'Хотели бы вы тестировать новые алгоритмы компании Dept на демо-счете?'));
INSERT INTO answers (text, correct, question_id) 
VALUES ('Нет, я не использую алгоритмы в торговле', FALSE, (SELECT id FROM questions WHERE text = 'Хотели бы вы тестировать новые алгоритмы компании Dept на демо-счете?'));

-- Вопрос 7: Сколько вам лет?
INSERT INTO questions (text, type) 
VALUES ('Сколько вам лет?', 'text') RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?', 'quiz') RETURNING id;
INSERT INTO quiz_questions (quiz_id, question_id) VALUES ((SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?'), (SELECT id FROM questions WHERE text = 'Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?'));
...
INSERT INTO questions (text, type) VALUES ('Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?', 'quiz') RETURNING id;
INSERT INTO quiz_questions (quiz_id, question_id) VALUES ((SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?'), (SELECT id FROM questions WHERE text = 'Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?'));
...
INSERT INTO questions (text, type) VALUES ('Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?', 'quiz') RETURNING id;
INSERT INTO quiz_questions (quiz_id, question_id) VALUES ((SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?'), (SELECT id FROM questions WHERE text = 'Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?'));
...
INSERT INTO questions (text, type) VALUES ('Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?', 'quiz') RETURNING id;
INSERT INTO quiz_questions (quiz_id, question_id) VALUES ((SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?'), (SELECT id FROM questions WHERE text = 'Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?'));
...
INSERT INTO questions (text, type) VALUES ('Почему не стоит жадничать, даже если цена входа лучше рекомендованной?', 'quiz') RETURNING id;
INSERT INTO quiz_questions (quiz_id, question_id) VALUES ((SELECT id FROM quizzes WHERE title = 'Умеешь ли ты правильно заходить в сделки?'), (SELECT id FROM questions WHERE text = 'Почему не стоит жадничать, даже если цена входа лучше рекомендованной?'));
