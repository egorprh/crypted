...
class Lesson(Base):
    ...
    duration = Column(String(255), comment="Длительность урока")
...
class Event(Base):
    ...
    button_color = Column(String(255), comment="Цвет кнопки")
    button_text = Column(String(255), default='', comment="Текст кнопки")
    sort_order = Column(BigInteger, default=0, comment="Порядок сортировки")
