...
SELECT pg_catalog.setval('public.quiz_attempts_id_seq', 232, true);
...
SELECT pg_catalog.setval('public.user_actions_log_id_seq', 1107, true);
...
SELECT pg_catalog.setval('public.user_answers_id_seq', 2619, true);
...
SELECT pg_catalog.setval('public.users_id_seq', 882, true);
