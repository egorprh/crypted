...
INSERT INTO questions (text, type) VALUES ('Что такое криптовалюта?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Как работает децентрализация в криптовалютах?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой криптовалютой считается "цифровое золото"?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что из перечисленного относится к стейблкойнам?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что из этого может усилить корреляцию между криптовалютами и фондовыми рынками?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что лучше всего описывает мемкоины?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему усилилась корреляция между криптовалютами и фондовыми индексами?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой индекс включает в себя крупнейшие технологические компании и влияет на крипторынок?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какое из следующих утверждений — преимущество криптовалют?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('В чем заключается ценность ограниченной эмиссии криптовалют, таких как Bitcoin?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой из следующих факторов прямо влияет на безопасность хранения средств на бирже?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему важно учитывать комиссии при выборе биржи?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что особенно важно в интерфейсе биржи для новичков?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Как репутация биржи может повлиять на ваше решение?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Зачем обращать внимание на регулирование биржи?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Для чего в первую очередь используется платформа TradingView?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Как называется инструмент на TradingView, с помощью которого можно рисовать уровни поддержки и сопротивления?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что позволяет сделать функция «Список наблюдения» (Watchlist)?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Для чего используется функция «Алерт» (оповещение) на TradingView?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Как сохранить собственный шаблон графика с нанесёнными индикаторами и разметкой?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что такое скальпинг в трейдинге?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Как называется торговля, при которой сделки открываются и закрываются в течение одного дня?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Кто больше всего склонен к свинг-трейдингу?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какая торговая стратегия требует наименьшего времени и эмоционального вовлечения?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой тип личности лучше всего подходит для скальпинга?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что может быть проблемой для интрадей-трейдера при длительном отсутствии сигналов?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему позиционные трейдеры часто менее подвержены эмоциональному напряжению?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что должно быть первым шагом при выборе торговой стратегии?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему важно тестировать стратегию на демо-счёте?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему важно учитывать свой тип личности при выборе стратегии?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что показывает показатель WinRate?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Если трейдер совершил 100 сделок, и 60 из них прибыльные, какой у него WinRate?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой уровень WinRate считается сбалансированным и подходящим для большинства стратегий?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что такое RR в трейдинге?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Если трейдер рискует $100, чтобы заработать $300, какой у него RR?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('При каком RR можно быть прибыльным даже с WinRate 30%?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что произойдет, если у трейдера высокий WinRate, но низкий RR (например, 1:1)?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой подход позволяет трейдеру зарабатывать даже при низком проценте прибыльных сделок?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему не стоит оценивать стратегию только по WinRate?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что из ниже перечисленного наиболее важно для стабильной прибыльности?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что должен осознать каждый, кто приходит на рынок в первую очередь?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('К чему чаще всего приводит торговля без стоп-лосса?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что происходит, если трейдер теряет половину депозита?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что важнее для сохранения капитала на рынке?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что может позволить трейдеру зарабатывать, даже если его стратегия неидеальна?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что такое биржевой стакан (Order Book)?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что происходит, когда маркет-ордер на покупку исполняется?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что делает лимитный ордер?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что такое проскальзывание?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Как влияет ликвидация лонгов на рынок?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что означает "агрессивный спрос" на рынке?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что делает iceberg-ордер особенным?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что такое spoofing?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Зачем маркет-мейкеры размещают встречные ордера в стакане?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему трейдерам важно следить за ликвидациями и глубиной стакана?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему трейдинг считается не просто работой, а особым путем?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что символизирует каждая сделка на рынке?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Как трейдинг помогает в развитии личности?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что даёт трейдеру ощущение независимости?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что объединяет всех успешных трейдеров?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что нужно делать, если вы заходите в сделку по цене лучше, чем рекомендованная точка входа?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что можно сделать, если цена уже ушла выше или ниже рекомендованной точки входа?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Зачем использовать разделение ордера на рыночный и лимитный, если цена хуже входа?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой из подходов считается наиболее спокойным и надёжным при неблагоприятной текущей цене?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Почему не стоит жадничать, даже если цена входа лучше рекомендованной?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что входит в состав D-Space и делает его особенно полезным для новичков и тех, кто хочет глубоко разобраться в трейдинге?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Что делает D-Closed особенно сильным для практикующих трейдеров?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Какой элемент присутствует и в D-Space, и в D-Closed, создавая сильное комьюнити?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('Чем полезен открытый канал department для широкой аудитории?', 1) RETURNING id;
...
INSERT INTO questions (text, type) VALUES ('В чём главное отличие всей экосистемы D-Product от большинства конкурентов?', 1) RETURNING id;
